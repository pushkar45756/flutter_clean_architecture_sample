...
import 'package:flutter_template/src/core/network/request_headers.dart';
import 'package:pretty_dio_logger/pretty_dio_logger.dart';

class DioProvider {
  static const String baseUrl = 'https://www.boredapi.com/api';
  ...
  static final _prettyDioLogger = PrettyDioLogger(
      ...
      requestBody: true,
      responseBody:
          true, //BuildConfig.instance.environment == Environment.DEVELOPMENT,
